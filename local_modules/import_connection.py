# -*- coding: utf-8 -*-
''' Import connection model from the data created by
    the objects in connection_design module.'''
...
class FaceWeldMetaData(ImportedMetaData):
    ...
    def getLegMinSize(self):
        ...
        return ASTM_materials.getFilletWeldMinimumLegSheets(t1,t2)
...
def pickHoleCenters(xcSet, blockDict):
    ...
    for p in xcSet.getPoints:
        ...
        if(objType=='hole_center' or objType=='anchor_point'):
            ...
            material= eval('ASTM_materials.'+pointAttributes['boltMaterial'])
